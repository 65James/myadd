	...
	<view style="padding-bottom: 50px;">
	 ...
	 <uni-swipe-action>
				...
				<view class="right">
					...
					<view class="box">
						...
						<view class="btn_group">
							<button class="btn" size="mini" @click="changeCount({k:2,index})" :disabled="item.goods_count==1">-</button>
							<input disabled :value="item.goods_count" class="ipt" placeholder="数量" type="text">
							<button class="btn" size="mini" @click="changeCount({k:1,index})"  :disabled="item.goods_count==10">+</button>
						</view>
					</view>
				</view>
		...
		<view class="bottom_box">
			<view class="">
				<radio :checked="allChose" color="red" @click="changeAll(!allChose)"></radio>全选
			</view>
			<view class="middle">
				<text>合计：</text>
...
<script>
	 import my_app  from "@/components/my_app/my_app.vue"
